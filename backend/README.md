...
## Project Structure
    ...
    ├── testapiautodatamod_115455  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_115455`
...
2. Clone this repo and `cd testapiautodatamod_115455`
